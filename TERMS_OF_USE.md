...
RemindMew is a self-improvement application designed to help users create reminders, journal, and optionally receive AI-generated content (collectively, the “Services”).

The App is intended for personal, non-commercial use unless we explicitly agree otherwise in writing.
...
- Attempt to disrupt, reverse engineer, or bypass security features of the App or its proxy services.
- Use the App to generate or promote hateful, violent, harassing, or illegal content.
...
The App, including its code, design, logos, and graphics (excluding User Content and third-party AI outputs), is owned by the developer and protected by applicable intellectual property laws.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT WILL WE BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, DATA, OR USE, ARISING OUT OF OR RELATED TO YOUR USE OF THE APP, INCLUDING AI-GENERATED CONTENT OR NOTIFICATION DELIVERY.
...
## 12. Contact
Questions about these Terms: oktatek@outlook.com
