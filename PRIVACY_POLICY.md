...
**The short version:** Your reminders and journal entries are stored **locally on your device**. We do **not** run user accounts and we do **not** store your content on our own servers. We use **OpenAI** to generate AI content when you request it, and we use **Firebase Analytics** to understand app usage and improve the product.

## 2. Data Stored on Your Device (Local-Only)
The App stores the following data locally on your phone/tablet:
- Reminders you create (including time and repeat settings)
- Notes you add to reminders (e.g., goals, actions, affirmations, gratitude)
- Journal entries (including mood, title, and content)
- App settings and preferences

We do not automatically back up this data to our own servers. If you delete the App or clear its storage, this data may be deleted from your device.
...
**We do not intentionally send your reminder text or journal content to Firebase Analytics.** Analytics is used to understand overall usage trends, not to identify you personally.
...
**We do not store your AI prompts or responses on our own servers** as part of normal operation.
...
- Your reminders, journal entries, and personal notes
- Your name, email address, phone number (unless you voluntarily send it in feedback outside the App)
